...
class _PerformanceMetricsWidgetState extends State<PerformanceMetricsWidget> {
  ...
  void initState() {
    super.initState();
    // Forcer un rebuild périodique pour afficher les métriques en temps réel
    _scheduleRebuild();
  }
    ...
    return ColoredBox(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: const Color(0xFFD2691E).withValues(alpha: 0.3), width: 1),
          boxShadow: [
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 8),
          Expanded(
            child: Text(label, style: TextStyle(fontSize: 14, color: const Color(0xFF8B4513).withValues(alpha: 0.8))),
          ),
          Text(
            value,
            style: TextStyle(fontSize: 14, fontWeight: isHighlight ? FontWeight.bold : FontWeight.w600, color: color),
          ),
        ],
      ),
    );
